...
## 🖥️ Frontend Integration (Blade Laravel)

This CMS includes a Laravel Blade-based frontend interface to consume the same API endpoints internally. You can access the dashboard at: 
http://127.0.0.1:8000
