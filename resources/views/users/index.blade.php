    ...
    <div class="layout-px-spacing">
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="row layout-top-spacing">
                @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('users-create'))
                    <div class="d-flex justify-content-start mb-3">
                        <a href="{{ route('create.users') }}" class="btn btn-primary">Create User</a>
                    </div>
                @endif
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <!-- Edit Button --> --}}
                                            @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('users-update'))
                                                <x-edit-button route="edit.users" :param="$user['id']" name="user" />
                                            @endif
                                            <!-- Delete Button -->
                                            @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('users-delete'))
                                                <x-delete-button route="destroy.users" :param="$user['id']" name="user" />
                                            @endif
                                    </tr>
                                @endforeach
                            </tbody>
