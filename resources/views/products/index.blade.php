    ...
    <div class="layout-px-spacing">
        ...
        <div class="middle-content container-xxl p-0">
            ...
            <div class="row layout-top-spacing">
                ...
                @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('roles-create'))
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>{{ $product['price'] }}</td>
                                        <td>
                                        @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('product-update'))
                                            <x-edit-button route="edit.products" :param="$product['id']" name="role" />
                                        @endif
                                        @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('product-delete'))
                                            <x-delete-button route="destroy.products" :param="$product['id']" name="role" />
                                        @endif
                                        </td>
                                    </tr>
                                @endforeach
