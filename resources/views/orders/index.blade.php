                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>{{ $order['status'] }}</td>
                                        <td>
                                        @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('orders-view'))
                                            <x-show-button route="show.orders" :param="$order['id']" name="order" />
                                        @endif

                                        @if (Auth::user()->is_super_admin || Auth::user()->hasPermission('orders-update'))
                                            <x-edit-button route="edit.orders" :param="$order['id']" name="order" />
                                        @endif
                                        </td>
